...
if __name__ == "__main__":
    # 1. Construction de dict_ctrl pour toutes les pièces du dossier
    #    (analyse robuste + figure de vérification enregistrée pour chacune,
    #    puis optimisation B-spline et classification bosse/creux/plat de
    #    chaque côté).
    dict_ctrl = construire_dict_ctrl_pour_plusieurs_pieces(
    ...
    # 3. Visualisation du schéma des pièces et de leurs associations
